...
夸克网盘~~签到~~、自动转存、命名整理、发推送提醒和刷新媒体库一条龙。
...
> [!WARNING]
> **使用 PC Web 端 Cookie 签到的功能已于 20240713 失效**，本来只是个顺便做的功能，。因新的签到接口需要移动端参数，抓包比较麻烦，暂时没有精力去适配，但也欢迎PR。需要签到的朋友请移步 [BNDou/Auto_Check_In](https://github.com/BNDou/Auto_Check_In/blob/main/checkIn_Quark.py) 项目。
